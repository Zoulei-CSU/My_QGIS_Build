...
需要用QGIS的时候，经常遇到安装很费劲的情况，而且安装完成后居然有好几个G。尤其是Arm架构下，QGIS安装比较费劲。所以我就自己编译了几个**绿色版本**，解压即用，或者直接执行。软件默认为简体中文，支持繁简英。
...
| [qgis_3.16_linux_glibc2.28_x86_64.AppImage](./download/v0.1/qgis_3.16_linux_glibc2.28_x86_64.AppImage) | 3.16 LTS | 104M | Linux x64   | 无Python。GLIBC版本>=2.28。                                  |
| [qgis_3.28_python_linux_glibc2.28_x86_64.AppImage](https://github.com/Zoulei-CSU/My_QGIS_Build/releases/download/v0.1/qgis_3.28_python_linux_glibc2.28_x86_64.AppImage) | 3.28 LTS | 186M | Linux x64   | 带Python，支持插件。GLIBC版本>=2.28。                        |
